...
export default function SingleReview({
  ...
  useEffect(() => {
    getLikedComments(loggedInUser.username).then((data) => {
        ...
        <div key={review.review_id} className={styles["review-box"]}>
          ...
          <div className={styles["main-review-box"]}>
            ...
            <div className={styles["review-text"]}>
              <h3>
                {review.title}{" "}
                {review.designer ? ` - By  ${review.designer}` : ""}
              </h3>
              {edittingReview.edittingReview &&
              edittingReview.reviewToEdit === review.review_id ? (
                <EditReviewsForm
                  setErr={setErr}
              ...
              >
                ...
                <div className={styles["main-comments-box"]}>
                  <div className={styles["comments-text"]}>
                    ...
                    edittingComment.commentToEdit === commentObj.comment_id ? (
                      <EditCommentsForm
                      ...
                      <p className={styles["comments-body-paragraph"]}>
                        {commentObj.body}
                      </p>
                    )}
                  </div>
                      ...
                      onClick={() => {
                        if (
                          ...
                          setCommentsList((currComments) => {
                            const newCommentss = currComments.map(
                              (comments) => {
                                return { ...comments };
                              }
                            );
                            const deletedIndex = newCommentss.findIndex(
                              (comments) =>
                                comments.comment_id === commentObj.comment_id
                            );
